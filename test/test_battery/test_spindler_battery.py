...
#battery_serviced_date = addYears(self.last_service_date, 3)
class TestSpindlerBattery(unittest.TestCase):
    def test_needs_service(self):
        #last_service_date.replace(year=last_service_date.year + 3)  < current_date : True
    ...
    def test_does_not_need_service(self):
        #last_service_date.replace(year=last_service_date.year + 3)  < current_date : False
        current_date = datetime.datetime(2022, 6, 4)
